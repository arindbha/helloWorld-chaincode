...
func (t *HelloWorld) write(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *HelloWorld) read(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
